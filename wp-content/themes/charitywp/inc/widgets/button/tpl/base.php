...
<div id="<?php echo esc_attr($id) ?>" class="text-<?php echo esc_attr($instance['align']); ?>">
	<a href="<?php echo esc_attr($instance['link']); ?>" class="thim-button <?php echo esc_attr($instance['style']); ?> inner size-<?php echo esc_attr($instance['size']); ?>"><?php echo esc_attr($instance['text']); ?></a>
</div>
