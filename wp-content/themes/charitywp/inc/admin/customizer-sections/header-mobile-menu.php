...
$header->addSubSection( array(
	'name'     => esc_html__( 'Mobile Menu', 'charitywp' ),
	'id'       => 'display_header_mobilemenu',
	'position' => 6,
) );

$header->createOption( array(
	"name"    => esc_html__( "Menu Background", 'charitywp' ),
	"id"      => "header_mobilemenu_bg_color",
	"default" => "#343434",
	"type"    => "color-opacity"
) );
...
$header->createOption( array(
	...
	"id"      => "header_mobilemenu_text_color",
	"default" => "#FFF",
	"type"    => "color-opacity"
) );
...
$header->createOption( array(
	...
	"id"      => "header_mobilemenu_link_hover_color",
	"default" => "#f8b864",
	"type"    => "color-opacity"
) );
...
$header->createOption( array(
	...
	"id"      => "header_mobilemenu_font_size",
	"default" => "13px",
	"type"    => "select",
	"options" => $font_sizes
) );
...
$header->createOption( array(
	...
	"id"      => "header_mobilemenu_font_weight",
	"default" => "bold",
	"type"    => "select",
...
$header->createOption( array(
	...
	"id"      => "header_mobilemenu_line",
	"default" => "mobile-not-line",
	"type"    => "select",
	"options" => array( 'mobile-line'   	=> 'Display Line',
...
$header->createOption( array(
	...
	"id"      => "header_mobilemenu_line_color",
	"default" => "#eee",
	"type"    => "color-opacity"
) );