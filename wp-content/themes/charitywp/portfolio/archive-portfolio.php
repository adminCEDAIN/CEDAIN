...
$portfolio_archive_layout  = $portfolio_data['thim_portfolio_layout'];
$portfolio_archive_filter  = $portfolio_data['thim_portfolio_filter'];
$portfolio_archive_style   = $portfolio_data['thim_portfolio_style'];
$portfolio_archive_columns = $portfolio_data['thim_portfolio_columns'];
$posts_per_page            = $portfolio_data['thim_portfolio_paging'];
$paged                     = get_query_var( 'paged' ) ? (int) get_query_var( 'paged' ) : 1;
$gutter                    = $portfolio_data['thim_portfolio_gutter'];
...
<div class="portfolio_container">
	...
	<div
		class="wrapper_portfolio <?php echo esc_attr( $filter ); ?> <?php echo esc_attr( $posts_per_page ); ?> <?php echo $portfolio_archive_style; ?> <?php echo $class_gutter; ?>">
